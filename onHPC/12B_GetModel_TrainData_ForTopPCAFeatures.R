...
outdir   <- paste0(proj_dir, "12B_TopPCAFeature_ModelReady_TrainData/WithPossibleMonthsHasNoCodes/")
...
######################################################################################################## 
#3.Output model ready data for top 2 features on dim1, dim 2 and Dim1 
######################################################################################################## 
model_data_4f <- model_data[,c("study_id","sample_id",
                               ...
                               "Enrolled_year",
                               "Label")]
save(model_data_4f, file=paste0(outdir, "4F_ModelReady_TrainData.rda"))
