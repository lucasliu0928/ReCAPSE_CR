...
outdir   <- paste0(proj_dir, "8_Characteristics2/Month_Level/MonthChar_WithEveryMonthsHasCodes/")


################################################################################
#1.Load patient level char
################################################################################
patient_level_char_df <- read.xlsx(paste0(data_dir1,"8_PatientLevel_char_WithEveryMonthsHasCodes.xlsx"),sheet = 1)
