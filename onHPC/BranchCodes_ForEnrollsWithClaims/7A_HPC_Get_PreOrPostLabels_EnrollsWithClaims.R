...
data_dir  <- paste0(proj_dir, "6_CleanClaims_InValidMonth/EnrolledMonths_WithEveryMonthsHasCodes/")
data_dir2 <- paste0(proj_dir, "4_RecurrDates_Outcome_Info/")
outdir    <- paste0(proj_dir, "7_PrePostLabels_AndAvailibility6mon/A_PrePost_Labels/EnrolledMonths_WithEveryMonthsHasCodes/")
