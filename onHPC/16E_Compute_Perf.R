...
get_SampledPrediction_byPOSvsNEG_Ratio <- function(predition_df, acutal_label_col,NEGtoPOS_Ratio){
  #acutal_label_col<- "actual"
  #NEGtoPOS_Ratio <- NEGtoPOS_ratio
...
write.csv(perf_tb_pos1_neg1,paste0(outdir,"train_DS",ds_index,"/BeforeSmoothed/",update_pred_flag,"_perf_tb_pos1_neg1",".csv"),row.names = T)
write.csv(perf_tb_pos1_neg2,paste0(outdir,"train_DS",ds_index,"/BeforeSmoothed/",update_pred_flag,"_perf_tb_pos1_neg2",".csv"),row.names = T)
write.csv(perf_tb_pos1_neg5,paste0(outdir,"train_DS",ds_index,"/BeforeSmoothed/",update_pred_flag,"_perf_tb_pos1_neg5",".csv"),row.names = T)
