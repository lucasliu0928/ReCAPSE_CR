...
data_dir2        <- paste0(proj_dir, "16A_Trained_FullModel/",feature_set_name,"/",sample_name,"/",SBCE_col,"/")

newout <- paste0("16B_Trained_ImportantFeatureModel/",feature_set_name,"/",sample_name,"/",SBCE_col,"/")
