...
#This scrip generate short GNN per month for each final ID (All enrolls)
...
outdir   <- paste0(proj_dir, "10F_ShortGNNFeature_inValidMonth/WithPossibleMonthsHasNoCodes/")
