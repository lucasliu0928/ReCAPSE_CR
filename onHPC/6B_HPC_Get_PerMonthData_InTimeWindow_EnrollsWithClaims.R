...
########################################################################################################################
ID_processed <- as.numeric(gsub("_perMonthData_Enrolled_inPredictionWindow.xlsx|ID","",list.files(paste0(outdir,"/EnrolledMonthes_WithPossibleNoCodes"))))
...
#   
#   write.xlsx(updated_enrolled_month_df,paste0(outdir,"EnrolledMonthes_WithPossibleNoCodes/","ID",curr_id,"_","perMonthData_Enrolled_inPredictionWindow.xlsx"))
# 
#   #Only keep the months that has at least one code
#   codes_index <- 5:ncol(updated_enrolled_month_df)
#   enrolled_month_df_filtered <- updated_enrolled_month_df[rowSums(is.na(updated_enrolled_month_df[,codes_index])) != ncol(updated_enrolled_month_df[,codes_index]), ] 
#   
#   write.xlsx(enrolled_month_df_filtered,paste0(outdir,"EnrolledMonths_WithCodes/","ID",curr_id,"_","perMonthData_Enrolled_inPredictionWindow.xlsx"))
#   
# }
