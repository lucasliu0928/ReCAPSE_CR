...
write.csv(grouped_unique_diag_df,paste0(outdir,"Unique_Diag_And_Groups.csv"),row.names = F)
...
write.csv(grouped_unique_proc_df,paste0(outdir,"Unique_Proc_And_Groups.csv"),row.names = F)

#3. DM3 drug codes
grouped_unique_drug_df <- group_drugcodes_into_DM3_func(unique_drug_df,DM3_df)
write.csv(grouped_unique_drug_df,paste0(outdir,"Unique_Drug_And_Groups.csv"),row.names = F)
