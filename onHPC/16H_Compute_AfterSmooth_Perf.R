...
write.csv(perf_tb_pos1_neg1,paste0(outdir,"train_DS",ds_index,"/AfterSmoothed","/perf_tb_pos1_neg1",".csv"),row.names = T)
write.csv(perf_tb_pos1_neg2,paste0(outdir,"train_DS",ds_index,"/AfterSmoothed","/perf_tb_pos1_neg2",".csv"),row.names = T)
write.csv(perf_tb_pos1_neg5,paste0(outdir,"train_DS",ds_index,"/AfterSmoothed","/perf_tb_pos1_neg5",".csv"),row.names = T)

#4.2 Compute performance for all samples
perf_tb_alltest <- get_perf_table_func(test_prediction_df,pts_level_char_df)
write.csv(perf_tb_alltest,paste0(outdir,"train_DS",ds_index,"/AfterSmoothed","/perf_tb_alltest",".csv"),row.names = T)
...
write.csv(ptlevel_perf_tb_alltest,paste0(outdir,"train_DS",ds_index,"/AfterSmoothed","/Patient_Level_Perf_tb_alltest",".csv"),row.names = T)
...
write.csv(monthdiff_stats,paste0(outdir,"train_DS",ds_index,"/AfterSmoothed","/Predicted_Monthdiff_stats",".csv"),row.names = T)
