...
n <- 5183
diag_feature_df <- get_code_feature_df_func(All_data[1:n,],grouped_unique_diag_df,"Unique_Diag_Codes","Diag_Codes","CCS_CATEGORY")
write.csv(diag_feature_df,paste0(outdir,"12_diag_feature_df.csv"),row.names = F)
proc_feature_df <- get_code_feature_df_func(All_data[1:n,],grouped_unique_proc_df,"Unique_Proc_Codes","Proc_Codes","CCS_CATEGORY")
write.csv(proc_feature_df,paste0(outdir,"12_proc_feature_df.csv"),row.names = F)
drug_feature_df <- get_code_feature_df_func(All_data[1:n,],grouped_unique_drug_df,"Unique_Drug_Codes","Drug_Codes","specific_group")
